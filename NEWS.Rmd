...
* __`survtab()` bug fix: standard errors were misspecificied for adjusted curves, e.g. age-adjusted Ederer II estimates. This resulted in too wide confidence intervals! SEE HERE FOR EAXMPLE: [#135](https://github.com/WetRobot/popEpi/issues/135)__. The standard errors and confidence intervals of non-adjusted curves have always been correct.
